        ...
        <div className="w-full h-[90px] flex justify-center items-center bg-white shadow">
            <div className="w-[1440px] h-[90px] flex justify-between items-center px-6">
                ...
                <div className="flex items-center gap-4">
                    <button className="flex items-center gap-2 px-6 py-3 border border-gray-300 rounded-l-lg bg-transparent cursor-pointer active:bg-[#ececec] transition">
                ...
                <div className="flex items-center gap-6">
                    <button className="flex items-center gap-2 px-5 py-3 bg-blue-100 text-blue-600 rounded-lg font-semibold cursor-pointer active:bg-[#e7e3e3] transition">
                        <img src={flag} alt="" className="h-5" />
                        <span>Ўз</span>
                        <i className='bx bx-chevron-down'></i>
                    </button>
                    
                    <button className="flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg font-bold cursor-pointer active:bg-[#7e86df] transition">
